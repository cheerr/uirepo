...
import com.mbui.sdk.afix.FixedImageView;
 ...
 */
public class AbsFeatureImageView extends FixedImageView implements AbsFeatureBuilder<AbsViewFeature<FixedImageView>> {

    private static final String debug = "AbsFeatureImageView";
    private ArrayList<AbsViewFeature<FixedImageView>> mFeatureList = new ArrayList<>();

    public AbsFeatureImageView(Context context) {
        this(context, null);
    }

    public AbsFeatureImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        constructor(context, attrs, 0);
    }

    public AbsFeatureImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @Override
    public void addFeature(@NonNull AbsViewFeature<FixedImageView> feature) {
    ...
    @Override
    public void removeFeature(@NonNull AbsViewFeature<FixedImageView> feature) {
        if (mFeatureList.contains(feature)) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (AbsViewFeature<FixedImageView> feature : mFeatureList) {
