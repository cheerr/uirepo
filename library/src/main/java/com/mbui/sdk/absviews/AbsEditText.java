 ...
 */
public class AbsEditText extends TEditText implements AbsFeatureBuilder<AbsViewFeature<TEditText>> {

    private static final String debug = "AbsEditText";
    private ArrayList<AbsViewFeature<TEditText>> mFeatureList = new ArrayList<>();
    ...
    @Override
    public void addFeature(@NonNull AbsViewFeature<TEditText> feature) {
    ...
    @Override
    public void removeFeature(@NonNull AbsViewFeature<TEditText> feature) {
        if (mFeatureList.contains(feature)) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        for (AbsViewFeature<TEditText> feature : mFeatureList) {
